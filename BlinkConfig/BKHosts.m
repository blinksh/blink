...
- (id)initWithCoder:(NSCoder *)coder
{
  ...
  _proxyJump = [coder decodeObjectForKey:@"proxyJump"];
  _sshConfigAttachment = [coder decodeObjectForKey:@"sshConfigAttachment"];
  _fpDomainsJSON = [coder decodeObjectForKey:@"fpDomainsJSON"];
  return self;
}
