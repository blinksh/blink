...
function blink_uio_activate() {
    ...
    window.term_touch = function(a, b, c, d, e, f, g) {
        ...
        if (h1) {
            if (Math.abs(a.pageX - j1) > 20) {
                h1 = null;
                return;
            }
            if (Math.abs(a.pageY - k1) > 20) {
                h1 = null;
                return;
            }
            if (h1.identifier != a.changedTouches[0].identifier) {
                h1 = null;
                return;
            }
            let c = Math.abs(a.timeStamp - i1);
            if (c > 500) {
                h1 = null, a.preventDefault(), a.stopPropagation();
                return;
            }
            if (c < 100 && 0 == b1 && !a.altKey && !a.ctrlKey && !a.metaKey && !a.shiftKey) {
                h1 = null, a.preventDefault(), a.stopPropagation();
                return;
            }
