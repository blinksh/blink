...
function blink_uio_activate() {
    ...
    window.term_touch = function(a, b, c, d, e, f, g) {
        ...
        if (h1) {
            ...
            let b = Math.abs(a.timeStamp - i1);
            if (b < 100 || b > 500) {
                //if (tsDelta > 600)  {
                h1 = null, a.preventDefault(), a.stopPropagation();
                return;
            }
            let c = new MouseEvent("mousedown", {
                bubbles: !0,
                cancelable: !0,
                view: window,
                altKey: a.altKey,
...
window.addEventListener("DOMContentLoaded", (a4)=>{
    blink_uio_activate(), document.body.contentEditable = !0, document.body.style = "word-wrap: normal;";
    var b = document.createElement("meta");
    b.name = "viewport", b.content = "viewport-fit=cover, width=device-width, height=device-height, initial-scale=1, user-scalable=no", document.getElementsByTagName("head")[0].appendChild(b), document.querySelectorAll("[tabIndex]").forEach(function(a) {
        a.tabIndex = -1;
    });
    let c = {
        op: "browser-ready"
    ...
    // @ts-ignore
    window.webkit.messageHandlers.interOp.postMessage(c);
});
