...
function blink_uio_activate() {
    ...
    let e1 = /^[a-z0-9\[\]\{\}~`\#\$-_=\+\|"|'\?]$/i;
    var f1 = 0;
    let g1 = new KeyMap(null), h1 = null, i1 = 0, j1 = 0, k1 = 0;
    function l1(a, b = document.activeElement) {
        if (b) {
            // @ts-ignore
            const [c, d] = [
                b.selectionStart,
    ...
    function o(a) {
        if (a.target === document.activeElement) {
            var g, h = !1;
            // @ts-ignore
            if ("ShiftLeft" === a.code ? (c2 = !0, h = !0) : "ShiftRight" === a.code && (d2 = !0, h = !0), !a.__blink) {
                let i = a.altKey || a.ctrlKey || a.shiftKey || a.metaKey;
                // @ts-ignore
                if (a.__noskip || i) ;
                else if (0 === b1) {
                    a.repeat && e1.test(a.key) ? 1 == (f1 += 1) ? l1(a.key, document.activeElement) : f1 %= 2 : f1 = 0;
                    return;
                }
                if (0 !== b1) {
                    let j = new KeyboardEvent("keydown", {
                        bubbles: a.bubbles,
                    ...
                    // @ts-ignore
                    j.__blink = !0, a.preventDefault(), //e.ctrlKey = keyDown.ctrlKey;
                    a.stopPropagation(), null === (g = document.activeElement) || void 0 === g || g.dispatchEvent(j);
                }
                h || m1("out", {
                    data: ""
                });
    ...
    function q(a) {
        !!a && (a.__blink || (a.tabIndex = -1, // @ts-ignore
        a.__blink = !0, a.autocapitalize = "none", // @ts-ignore
        a.autocorrect = !1, a !== document.body && (a.addEventListener("keydown", o, !0), a.addEventListener("keyup", p, !0))));
    }
    window.term_paste = function(a) {
        l1(a);
    }, window.term_getCurrentSelection = function() {
        ...
        n1("selectionchange", term_getCurrentSelection());
    }), // @ts-ignore
    window._onKB = function(a3, e2) {
        switch(a3){
            case "state-reset":
                b1 = 0, c2 = !1, d2 = !1, f1 = 0;
                break;
            case "toolbar-mods":
                var h2, i2;
                b1 = h2 = e2, (i2 = document.activeElement) && (0 == h2 ? // @ts-ignore
                i2.readOnly = i2.__readOnly : // @ts-ignore
                i2.__readOnly = i2.readOnly);
                break;
            case "toolbar-press":
                !function(a) {
                    var b;
                    ...
                    var e = a.split(/:/g);
                    let h = parseInt(e[0], 10), i = parseInt(e[1], 10), j = "" == e[3] ? ":" : e[3] || g1.key(i) || "", k = g1.code(i), n = new KeyboardEvent("keydown", {
                        bubbles: !0,
                        cancelable: !0,
                        composed: !1,
                        isComposing: !1,
                        ...
                        key: j,
                        code: k,
                        /*repeat: true,*/ metaKey: (1048576 & h) == 1048576,
                        ctrlKey: (262144 & h) == 262144,
                        altKey: (524288 & h) == 524288,
                        shiftKey: c2 || d2
                    });
                    f1 = 0, null === (b = document.activeElement) || void 0 === b || b.dispatchEvent(n), m1("out", {
                        data: ""
                    });
                }(e2);
                break;
    ...
    window.term_touch = function(a, b, c, d, e, f, g) {
        ...
        let i = c + e, j = d + f;
        if ("touchstart" === a) {
            let k = new PointerEvent("pointerdown", {
                target: h,
                bubbles: !0,
                cancelable: !0,
                pointerType: "touch",
        ...
        if (a.target.classList.contains("action-label")) {
            h1 = null;
            return;
        }
        ...
        if ("direct" !== (h1 = a.changedTouches[0]).touchType) {
            h1 = null;
            return;
        }
        i1 = a.timeStamp, j1 = a.pageX, k1 = a.pageY, console.log(a);
    }, document.ontouchend = function(a) {
        let c = h1;
        if (h1 = null, c && !(Math.abs(a.pageX - j1) > 20) && !(Math.abs(a.pageY - k1) > 20) && c.identifier == a.changedTouches[0].identifier) {
            let d = Math.abs(a.timeStamp - i1);
            if (!(d > 900) && (!(d < 250) || 0 != b1 || a.altKey || a.ctrlKey || a.metaKey || a.shiftKey)) {
                a.preventDefault(), a.stopPropagation();
                let e = new MouseEvent("click", {
                    bubbles: !0,
                    cancelable: !0,
                    view: window,
                    altKey: a.altKey || (524288 & b1) == 524288,
                    ctrlKey: a.ctrlKey || (262144 & b1) == 262144,
                    metaKey: a.metaKey || (1048576 & b1) == 1048576,
                    shiftKey: a.shiftKey,
                    pageX: j1,
                    pageY: k1,
                    screenX: j1,
...
function __install_uio() {
    if (!window._onKB) {
        blink_uio_activate(), document.body.contentEditable = !0, document.body.style = "word-wrap: normal;";
        var a4 = document.createElement("meta");
        a4.name = "viewport", a4.content = "viewport-fit=cover, width=device-width, height=device-height, initial-scale=1, user-scalable=no", document.getElementsByTagName("head")[0].appendChild(a4), document.querySelectorAll("[tabIndex]").forEach(function(a) {
            a.tabIndex = -1;
        });
        let b = {
            op: "browser-ready"
        ...
        // @ts-ignore
        window.webkit.messageHandlers.interOp.postMessage(b);
    }
}
window.addEventListener("DOMContentLoaded", (a)=>{
    var b = 0;
    const c = setInterval(()=>{
        b += 1, document.getElementsByClassName("monaco-workbench").length > 0 && (__install_uio(), clearInterval(c)), b > 12000 && clearInterval(c);
    }, 50);
});
