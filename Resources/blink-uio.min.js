...
function blink_uio_activate() {
    ...
    function k1(a) {
        if (a.target === document.activeElement) {
            var g, j = !1;
            // @ts-ignore
            if ("ShiftLeft" === a.code ? (c2 = !0, j = !0) : "ShiftRight" === a.code && (d2 = !0, j = !0), !a.__blink) {
                let k = a.altKey || a.ctrlKey || a.shiftKey || a.metaKey;
                // @ts-ignore
                if (a.__noskip || k) ;
                else if (0 === b1) {
                ...
                if (0 !== b1) {
                    ...
                    // @ts-ignore
                    l.__blink = !0, a.preventDefault(), //e.ctrlKey = keyDown.ctrlKey;
                    a.stopPropagation(), null === (g = document.activeElement) || void 0 === g || g.dispatchEvent(l);
                }
                j || i1("out", {
                    data: ""
                });
    ...
    function m1(a) {
        ...
        a.autocorrect = !1, a !== document.body && (a.addEventListener("keydown", k1, !0), a.addEventListener("keyup", l1, !0))));
    }
    window.term_paste = function(a) {
        ...
        j1("selectionchange", term_getCurrentSelection());
    }), // @ts-ignore
            ...
            case "toolbar-press":
                !function(a) {
                    ...
                    let j = parseInt(e[0], 10), k = parseInt(e[1], 10), l = "" == e[3] ? ":" : e[3] || g1.key(k) || "", m = g1.code(k), n = new KeyboardEvent("keydown", {
                        ...
                        key: l,
                        code: m,
                        /*repeat: true,*/ metaKey: (1048576 & j) == 1048576,
