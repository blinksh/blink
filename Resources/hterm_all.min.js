...
this.textAttributes.matchesContainer(g)?(setNodeText(g,g.textContent+a),this.cursorNode_=g,this.cursorOffset_=lib.wc.strWidth(g.textContent)):(a=this.textAttributes.createContainer(a),this.cursorRowNode_.insertBefore(a,c),this.cursorNode_=a,this.cursorOffset_=b):0==g?(b=c.nextSibling)&&this.textAttributes.matchesContainer(b)?(setNodeText(b,a+b.textContent),this.cursorNode_=b,this.cursorOffset_=lib.wc.strWidth(a)):(a=this.textAttributes.createContainer(a),this.cursorRowNode_.insertBefore(a,b),this.cursorNode_=
a,this.cursorOffset_=hterm.TextAttributes.nodeWidth(a)):(this.splitNode_(c,e),a=this.textAttributes.createContainer(a),this.cursorRowNode_.insertBefore(a,c.nextSibling),this.cursorNode_=a,this.cursorOffset_=b)};
