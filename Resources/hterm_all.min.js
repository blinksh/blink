...
$jscomp.polyfill("Object.assign",function(a){return a?a:function(a,c){for(var b=1;b<arguments.length;b++){var e=arguments[b];if(e)for(var g in e)$jscomp.owns(e,g)&&(a[g]=e[g])}return a}},"es6","es3");if("undefined"!=typeof lib)throw Error('Global "lib" object already exists.');
...
lib.resource.add("hterm/concat/date","text/plain","Mon, 08 Jan 2018 10:52:02 +0000");lib.resource.add("hterm/changelog/version","text/plain","1.77");lib.resource.add("hterm/changelog/date","text/plain","2018-01-05");lib.resource.add("hterm/git/HEAD","text/plain","git rev-parse HEAD");"use strict";lib.rtdep("lib.Storage");
...
hterm.Frame=function(a,b,c){this.terminal_=a;this.div_=a.div_;this.url=b;this.options=c||{};this.messageChannel_=this.container_=this.iframe_=null};hterm.Frame.prototype.onMessage_=function(a){switch(a.data.name){case "ipc-init-ok":this.sendTerminalInfo_();break;case "terminal-info-ok":this.container_.style.display="flex";this.messageChannel_.port1.onmessage=this.onMessage.bind(this);this.onLoad();break;default:console.log("Unknown message from frame:",a.data)}};hterm.Frame.prototype.onMessage=function(){};
...
hterm.Parser.prototype.parseEscape=function(){var a={'"':'"',"'":"'","\\":"\\",a:"\u0007",b:"\b",e:"\u001b",f:"\f",n:"\n",r:"\r",t:"\t",v:"\x0B",x:function(){var a=this.parsePattern(/[a-z0-9]{2}/gi);return String.fromCharCode(parseInt(a,16))},u:function(){var a=this.parsePattern(/[a-z0-9]{4}/gi);return String.fromCharCode(parseInt(a,16))}};if(!(this.ch in a&&a.hasOwnProperty(this.ch)))throw this.error("Unknown escape: "+this.ch);a=a[this.ch];this.advance(1);"function"==typeof a&&(a=a.call(this));
...
hterm.Screen.prototype.splitNode_=function(a,b){var c=a.cloneNode(!1),d=a.textContent;a.textContent=hterm.TextAttributes.nodeSubstr(a,0,b);c.textContent=lib.wc.substr(d,b);c.textContent&&a.parentNode.insertBefore(c,a.nextSibling);a.textContent||a.parentNode.removeChild(a)};
...
c.nodeType!=Node.TEXT_NODE&&(c.wcNode||!c.asciiNode||c.tileNode||c.style.textDecoration||c.style.backgroundColor)?(d=c.ownerDocument.createTextNode(h),this.cursorRowNode_.insertBefore(d,c.nextSibling),this.cursorNode_=c=d,this.cursorOffset_=e=-g,d=h):c.textContent=d+=h:a=h+a;g=0}this.textAttributes.matchesContainer(c)?(c.textContent=0==g?d+a:0==e?a+d:hterm.TextAttributes.nodeSubstr(c,0,e)+a+hterm.TextAttributes.nodeSubstr(c,e),this.cursorOffset_+=b):0==e?(g=c.previousSibling)&&this.textAttributes.matchesContainer(g)?
(g.textContent+=a,this.cursorNode_=g,this.cursorOffset_=lib.wc.strWidth(g.textContent)):(a=this.textAttributes.createContainer(a),this.cursorRowNode_.insertBefore(a,c),this.cursorNode_=a,this.cursorOffset_=b):0==g?(b=c.nextSibling)&&this.textAttributes.matchesContainer(b)?(b.textContent=a+b.textContent,this.cursorNode_=b,this.cursorOffset_=lib.wc.strWidth(a)):(a=this.textAttributes.createContainer(a),this.cursorRowNode_.insertBefore(a,b),this.cursorNode_=a,this.cursorOffset_=hterm.TextAttributes.nodeWidth(a)):
(this.splitNode_(c,e),a=this.textAttributes.createContainer(a),this.cursorRowNode_.insertBefore(a,c.nextSibling),this.cursorNode_=a,this.cursorOffset_=b)};
...
hterm.TextAttributes.prototype.isDefault=function(){return this.foregroundSource==this.SRC_DEFAULT&&this.backgroundSource==this.SRC_DEFAULT&&!this.bold&&!this.faint&&!this.italic&&!this.blink&&!this.underline&&!this.doubleUnderline&&!this.strikethrough&&!this.inverse&&!this.invisible&&!this.wcNode&&this.asciiNode&&null==this.tileData&&null==this.uri};
...
g="";this.underline&&(e+=" underline",b.underline=!0);this.doubleUnderline&&(this.underline||(e+=" underline"),g="double",b.doubleUnderline=!0);this.strikethrough&&(e+=" line-through",b.strikethrough=!0);e&&(c.textDecorationLine=e);g&&(c.textDecorationStyle=g);this.wcNode&&(d.push("wc-node"),b.wcNode=!0);b.asciiNode=this.asciiNode;null!=this.tileData&&(d.push("tile"),d.push("tile_"+this.tileData),b.tileNode=!0);a&&(b.textContent=a);this.uri&&(d.push("uri-node"),b.uriId=this.uriId,b.title=this.uri,
b.addEventListener("click",hterm.openUrl.bind(this,this.uri)));d.length&&(b.className=d.join(" "));return b};
hterm.TextAttributes.prototype.matchesContainer=function(a){if("string"==typeof a||a.nodeType==Node.TEXT_NODE)return this.isDefault();var b=a.style;return!(this.wcNode||a.wcNode)&&this.asciiNode==a.asciiNode&&!(null!=this.tileData||a.tileNode)&&this.uriId==a.uriId&&this.foreground==b.color&&this.background==b.backgroundColor&&(this.enableBold&&this.bold)==!!b.fontWeight&&this.blink==!!a.blinkNode&&this.italic==!!b.fontStyle&&!!this.underline==!!a.underline&&!!this.doubleUnderline==!!a.doubleUnderline&&
...
this.DEFAULT_COLOR?this.defaultForeground:this.foreground,"rgb(0, 0, 0)",.3333));b==this.SRC_DEFAULT?this.background=d:Number.isInteger(b)?this.background=this.colorPalette[b]:this.background=b;this.invisible&&(this.foreground=this.background)};
hterm.TextAttributes.containersMatch=function(a,b){if("string"==typeof a)return hterm.TextAttributes.containerIsDefault(b);if(a.nodeType!=b.nodeType)return!1;if(a.nodeType==Node.TEXT_NODE)return!0;a=a.style;b=b.style;return a.color==b.color&&a.backgroundColor==b.backgroundColor&&a.fontWeight==b.fontWeight&&a.fontStyle==b.fontStyle&&a.textDecoration==b.textDecoration};hterm.TextAttributes.containerIsDefault=function(a){return"string"==typeof a||a.nodeType==Node.TEXT_NODE};
hterm.TextAttributes.nodeWidth=function(a){return a.asciiNode?a.textContent.length:lib.wc.strWidth(a.textContent)};hterm.TextAttributes.nodeSubstr=function(a,b,c){return a.asciiNode?a.textContent.substr(b,c):lib.wc.substr(a.textContent,b,c)};hterm.TextAttributes.nodeSubstring=function(a,b,c){return a.asciiNode?a.textContent.substring(b,c):lib.wc.substring(a.textContent,b,c)};
...
hterm.VT.CSI.m=function(a){var b=this.terminal.getTextAttributes();if(a.args.length){for(var c=0;c<a.args.length;c++){var d=a.iarg(c,0);30>d?0==d?b.reset():1==d?b.bold=!0:2==d?b.faint=!0:3==d?b.italic=!0:4==d?b.underline=!0:5==d?b.blink=!0:7==d?b.inverse=!0:8==d?b.invisible=!0:9==d?b.strikethrough=!0:21==d?b.doubleUnderline=!0:22==d?(b.bold=!1,b.faint=!1):23==d?b.italic=!1:24==d?(b.underline=!1,b.doubleUnderline=!1):25==d?b.blink=!1:27==d?b.inverse=!1:28==d?b.invisible=!1:29==d&&(b.strikethrough=
!1):50>d?38>d?b.foregroundSource=d-30:38==d?(d=this.parseSgrExtendedColors(a,c,b),void 0!==d.color&&(b.foregroundSource=d.color),c+=d.skipCount):39==d?b.foregroundSource=b.SRC_DEFAULT:48>d?b.backgroundSource=d-40:48==d?(d=this.parseSgrExtendedColors(a,c,b),void 0!==d.color&&(b.backgroundSource=d.color),c+=d.skipCount):b.backgroundSource=b.SRC_DEFAULT:90<=d&&97>=d?b.foregroundSource=d-90+8:100<=d&&107>=d&&(b.backgroundSource=d-100+8)}b.setDefaults(this.terminal.getForegroundColor(),this.terminal.getBackgroundColor())}else b.reset()};
hterm.VT.CSI.m.supportsSubargs=!0;hterm.VT.CSI[">m"]=hterm.VT.ignore;hterm.VT.CSI.n=function(a){if(5==a.args[0])this.terminal.io.sendString("\u001b0n");else if(6==a.args[0]){a=this.terminal.getCursorRow()+1;var b=this.terminal.getCursorColumn()+1;this.terminal.io.sendString("\u001b["+a+";"+b+"R")}};hterm.VT.CSI[">n"]=hterm.VT.ignore;
...
lib.resource.add("hterm/images/icon-96","image/png;base64","base64  --  Encode/decode file as base64.  Call:            base64 [-e / -d] [options] [infile] [outfile]Options:           --copyright       Print copyright information           -d, --decode      Decode base64 encoded file           -e, --encode      Encode file into base64           -n, --noerrcheck  Ignore errors when decoding           -u, --help        Print this message           --version         Print version numberby John Walkerhttp://www.fourmilab.ch/");
lib.resource.add("hterm/concat/date","text/plain","Mon, 08 Jan 2018 10:52:03 +0000");lib.resource.add("hterm/changelog/version","text/plain","1.77");lib.resource.add("hterm/changelog/date","text/plain","2018-01-05");lib.resource.add("hterm/git/HEAD","text/plain","git rev-parse HEAD");
