...
$jscomp.polyfill("Object.assign",function(a){return a||$jscomp.assign},"es6","es3");function setNodeText(a,b){a.textContent=b;var c=b.length;"SPAN"===a.nodeName&&(c&&!a.asciiNode&&(c=lib.wc.strWidth(b)),a._len!==c&&(a._len=c,a.style.display="inline-block",a.style.overflowX="hidden",a.style.width="calc(var(--hterm-charsize-width) * "+c+")"))}if("undefined"!=typeof lib)throw Error('Global "lib" object already exists.');
