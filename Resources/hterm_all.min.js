...
$jscomp.polyfill("Object.assign",function(a){return a?a:function(a,c){for(var b=1;b<arguments.length;b++){var e=arguments[b];if(e)for(var g in e)$jscomp.owns(e,g)&&(a[g]=e[g])}return a}},"es6","es3");function setNodeText(a,b){a.textContent=b;var c=b.length;"SPAN"===a.nodeName&&(c&&!a.asciiNode&&(c=lib.wc.strWidth(b)),a._len!==c&&(a._len=c,a.style.display="inline-block",a.style.overflowX="hidden",a.style.width="calc(var(--hterm-charsize-width) * "+c+")"))}
