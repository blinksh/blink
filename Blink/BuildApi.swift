...
enum BuildAPI {
  ...
  private static func serviceCall(ctx: NSObject, url: String, method: String, body: String, contentType: String, auth: Bool, callback: build_service_callback) -> TokioSignals {
