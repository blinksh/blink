...
* Tapping and scrolling with a single finger will emulate the usage of a mouse. Try it to scroll your vim or emacs buffers, or to position the cursor exactly where you want.
...
* To create a new shell, you can tap the screen with two fingers.
